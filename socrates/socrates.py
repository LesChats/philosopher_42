...
def make_all_binaries(bin_path):
    subprocess.run(["make", "-C", f"{bin_path}"])
    ...
    parser.add_argument(
        ...
        help=textwrap.dedent(
            ...
            Number of the philosopher program to test
             - 0: mandatory philo (default)
             - 1: mandatory and bonus philo (default)
        """
        ),
        type=int,
        choices=[0, 1],
